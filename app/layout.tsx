...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepindosmp.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'vJxcDa2M-kL_VZHW_Dh_LwnO7xKR3RmEWeUtBgzi4Nw',
        yandex: 'a31805d1a2b9f65d',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "logo": "https://bokepindosmp.pages.dev/favicon.ico",
        "url": "https://bokepindosmp.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepindosmp.pages.dev"
        ...
        "url": "https://bokepindosmp.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "image": "https://bokepindosmp.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepindosmp.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepindosmp.pages.dev/?q={search_term}", 
